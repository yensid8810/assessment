...
/**
 * 指定した要素の子どもを全て削除する
 * @param{HTMLElement}elemement HTMLの要素
 */
...
const answers = [
    ...
    '{userName}のいいところは見た目です。内側から溢れる{userName}の良さに皆が気を引かれます',
    ...
    '{userName}のいいところは自制心です。やばいと思ったときにしっかりと衝撃をおさえられる{userName}が皆から評価されています',
